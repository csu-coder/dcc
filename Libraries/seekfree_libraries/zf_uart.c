...
uint16 USART4_RX_LEN=0;   					//接收长度
uint8  USART4_RX_STA=EMPTY;    					//接收完成标志位
uint8  uart4_tx_buff[UART4_TX_BUFFER_SIZE];	//发送缓冲
uint8  uart4_rx_buff[UART4_RX_BUFFER_SIZE];	//接收缓冲
